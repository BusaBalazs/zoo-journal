import { IconLeaf, IconBook } from '../components/icons'
import lionBg from "../assets/landing-lion.jpg"
    ...
    <div className="min-h-screen max-w-md mx-auto relative flex flex-col text-white overflow-hidden">
      ...
      <div className="relative flex-1 flex flex-col justify-end px-6 pb-9 pt-8">
        <div className="flex items-center gap-2 mb-auto">
          <span className="w-8 h-8 rounded-xl bg-[color:white]/15 backdrop-blur-sm flex items-center justify-center">
            <IconLeaf className="w-6 h-6" />
          </span>
          <div className="leading-tight">
            <p className="text-sm text-white font-bold -mt-0.5">{t('appSubtitle')}</p>
          </div>
